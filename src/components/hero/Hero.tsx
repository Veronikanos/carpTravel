  ...
  return (
    <section>
      <div className="padding-x hero-section">
        <div className="flex flex-col gap-6 md:h-[345px]  md:gap-x-12 md:gap-y-0 md:grid md:grid-rows-3 md:grid-flow-col">
            
            <h1 className="header-1 first-letter:font-medium w-[118px] ml-auto tracking-[1.66px] leading-normal md:w-auto md:col-span-2 ">
            7days
            ...
            <div className="md:-order-1 md:row-span-3 ">
                <h2 className="header-2 first-line:font-medium  md:max-w-[426px] md:mb-[58px] md:leading-[82px]">
            ...
            <div className="md:row-span-2 col-span-2 flex flex-col justify-end ">
